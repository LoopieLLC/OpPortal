class WashersController < ApplicationController
  ...
  private
    ...
    def washer_params
      params.require(:washer).permit(:username, :password, :firstname, :lastname, :phone, :email, :address, :washing_status, :max_loads, :current_loads, :total_loads_completed, :machine_description, :start_date, :confirmation_status)
    end
end
