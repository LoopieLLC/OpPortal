class WashersController < ApplicationController
  ...
  private
    ...
    def washer_params
      params.require(:washer).permit(:username, :password, :firstname, :lastname, :phone, :email, :address, :status, :max_loads, :current_loads, :machine_description, :start_date, :total_loads_completed)
    end
end
