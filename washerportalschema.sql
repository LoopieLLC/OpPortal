...
--
-- Host: localhost    Database: washerportaldev
-- ------------------------------------------------------
...
CREATE TABLE `washers` (
  ...
  `status` int(11) NOT NULL,
  `max_loads` int(11) NOT NULL,
  `current_loads` int(11) NOT NULL,
  `description_of_washer` text,
  `start_date` date DEFAULT NULL,
  `total_loads_completed` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-10 14:23:56
